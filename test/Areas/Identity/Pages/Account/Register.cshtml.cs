...
namespace test.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList = _roleManger.Roles.Select(r => r.Name).Select(i => new SelectListItem { Text = i, Value = i }),
                CompanyList=_ufw.company.GetAll().Select(c=> new SelectListItem { Text=c.Name,Value=c.Id.ToString()})
            };
        }
